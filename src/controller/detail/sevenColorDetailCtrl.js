var sevenColorDetailCtrl = ['$rootScope', '$scope', 'api','$routeParams','ngDialog',
  function ($rootScope, $scope, api,$routeParams,ngDialog) {
    var data = {
      form_data: {//页面数据
  ...
  sevenColorDetailCtrl.$injector = ['$rootScope', '$scope', 'api','$routeParams','ngDialog'];